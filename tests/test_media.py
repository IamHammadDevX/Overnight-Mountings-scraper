...
def test_static_alt_media_maps_to_colors():
    html = '''<script id="product-images" type="application/json">["https://a/base.jpg", "https://a/base.alt.jpg", "https://a/base.alt1.jpg"]</script><script id="product-videos" type="application/json">["https://a/video.white.mp4", "https://a/video.yellow.mp4", "https://a/video.rose.mp4"]</script>'''
    ...
    assert parse_color_media(html, "Yellow").videos == ["https://a/video.yellow.mp4"]
    assert parse_color_media(html, "Rose").videos == ["https://a/video.rose.mp4"]
